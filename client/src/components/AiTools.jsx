  ...
  return (
    <div className='px-4 sm:px-20 x1:px-32 my-24'>
      <div className='text-center'>
        ...
        <p className='text-gray-500 max-w-1g mx-auto'>Everything you need to create, enhance, and optimize your content with cutting-edge AI technology.</p>
      </div>
      <div className='flex flex-wrap mt-10 justify-center'>
        {
            AiToolsData.map((tool, index) => (
                <div key={index} className='p-8 m-4 max-w-xs rounded-1g bg-surface
