...
const BlogTitles = () => {
  const blogCategories = ['General', ' Lifestyle', 'Education', 'Travel', 'Technology', 'Business', 'Health', 'Food'];

  const [selectedCategory, setsSelectedCategory] = useState('General');
  ...
  return (
    <div className='h-full overflow-y-scroll p-30 pt-8 flex items-start flex-wrap gap-2
text-slate-700'>
        {/* left col  */}
        <form onSubmit={onSubmitHandler} className='w-full p-4 bg-white rounded-lg border border-gray-200'>
            ...
            <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
                  ...
                  <span
                    key={item}
                    onClick={() => setsSelectedCategory(item)}
            ...
            <br />
            <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-linear-to-r btn-primary text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
